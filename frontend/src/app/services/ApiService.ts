...
export class WebSocketService {
  ...
  // Spectrum events
  onSpectrumUpdate(callback: (data: SpectrumData) => void) {
    void callback;
  }

  offSpectrumUpdate(callback: (data: SpectrumData) => void) {
    void callback;
  }

  // Waterfall events
  onWaterfallUpdate(callback: (data: WaterfallData) => void) {
    void callback;
  }

  offWaterfallUpdate(callback: (data: WaterfallData) => void) {
    void callback;
  }

  // Device status events
  onDeviceStatusUpdate(callback: (data: DeviceStatus) => void) {
    void callback;
  }

  offDeviceStatusUpdate(callback: (data: DeviceStatus) => void) {
    void callback;
  }
